 ...
 */
public class IvtNextLegReplanner extends WithinDayDuringActivityReplanner {

	private static final Logger log = Logger.getLogger(EditTrips.class) ;
	
	private final TripRouter tripRouter;

	IvtNextLegReplanner(Id<WithinDayReplanner> id, Scenario scenario, ActivityEndRescheduler internalInterface, TripRouter tripRouter) {
	...
	public boolean doReplanning(MobsimAgent withinDayAgent) {
		...
		log.info("We entered doReplanning inside NextLegReplanner");
		...
		log.info("We managed to get to the last line of doReplanning inside IvtNextLegReplanner");
