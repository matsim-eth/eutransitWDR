...
public class IvtNextLegReplannerFactoryChooseMode extends WithinDayDuringActivityReplannerFactory {
	...
	public IvtNextLegReplannerFactoryChooseMode(Scenario scenario, WithinDayEngine withinDayEngine,
	...
	public WithinDayDuringActivityReplanner createReplanner() {
		WithinDayDuringActivityReplanner replanner = new IvtNextLegReplannerChooseMode(super.getId(), this.scenario,
